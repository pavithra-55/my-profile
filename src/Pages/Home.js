                ...
                <Row className="align-items-center">
                    <Col lg='6' className="text-lg-start text-center">
                        ...
                        <div className="gap-3 mt-4 fs-4">
                             <a className="text-decoration-none link-underline p-2" rel="noreferrer" href="https://github.com/pavithra-55" aria-label="GitHub" target="_blank"><i
                            className="bi bi-github"></i></a>
                            <a className="text-decoration-none link-underline p-2" rel="noreferrer" href="https://www.linkedin.com/in/pavithra1755ns" aria-label="LinkedIn" target="_blank"><i
                                    className="bi bi-linkedin"></i></a>
                            <a className="text-decoration-none link-underline p-2" rel="noreferrer" href="https://leetcode.com/u/Pavi_55/" aria-label="LeetCode" target="_blank"><i
